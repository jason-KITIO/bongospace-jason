...
function NewFactures() {
    ...
    const [listeClient, setListeClient] = useState(false);

    const toggleDropdown = () => {
        setIsDropdownOpen(!isDropdownOpen);
    };

    const toggleListeClient = () => {
                    ...
                    <div className='block'>
                        <div className='gauche gauche-client gauche-client-new-facture'>
                            ...
                            <table className='corps'>
                                ...
                                <Produit nom={'Voiture'} description={'C’est une voiture de sport'} quantite={3} prix={1500} />
                        ...
                        <div className='droite-client new-Facture-nom'>
                            <p>Client</p>
                            <div className={listeClient ? 'dropdown-active' : 'dropdown'}>
                                ...
                                {isDropdownOpen && (
                                    <div className="dropdown-menu">
                                        {clients.map(client => (
                                            <div className='dropdown-item' onClick={() => handleClientSelect(client)}>
                            ...
                            <div className="dropdown">
                                {selectedClient && (
                                    <div className='new-Facture-droite'>
                                        ...
                                        <p className='nom'>{selectedClient.attributes.Nom}</p>
                                        <span>{selectedClient.attributes.Ville}</span>
                                        <span>{selectedClient.attributes.Quartier}</span>
                                        <span>{selectedClient.attributes.Telephone}</span>
                                        <span>{selectedClient.attributes.Email}</span>
                                    </div>
                                )}
                            </div>
                        </div>
